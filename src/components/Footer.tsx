      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex items-center gap-3 mt-4">
              <Link
                ...
                className="w-11 h-11 rounded-lg bg-white/5 hover:bg-hydra-cyan/20 flex items-center justify-center transition-colors"
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-gray-400">
              <li>
                <Link
                  href="/#services"
                  className="hover:text-hydra-cyan transition-colors py-1.5 inline-block"
                >
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              <li className="flex items-center gap-2">
                ...
                <Link
                  href="tel:8334937229"
                  className="hover:text-hydra-cyan transition-colors font-semibold text-white py-1.5 inline-block"
                >
                  833-493-7229
                </Link>
              </li>
            ...
            <Link
              ...
              className="inline-flex items-center gap-1 text-sm text-hydra-cyan hover:text-white transition-colors mt-4 py-1.5"
            >
              Customer Portal
            ...
            <Link
              href="/portal"
              className="inline-flex items-center gap-1 text-sm text-gray-400 hover:text-white transition-colors mt-2 py-1.5"
            >
              Employee Portal
              <ArrowUpRight className="w-3.5 h-3.5" />
            </Link>
        ...
        <div className="pt-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-gray-500">
          ...
          <div className="flex items-center gap-4">
            <Link href="/privacy" className="hover:text-gray-300 transition-colors py-1 inline-block">
              Privacy Policy
            </Link>
            <Link href="/terms" className="hover:text-gray-300 transition-colors py-1 inline-block">
              Terms of Service
            </Link>
          </div>
        </div>
